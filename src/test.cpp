...
void init(GLFWwindow* window) {
    ...
    T_.init(cam_.getViewMatrix(), light_.getLightPos(), window_height_, window_width_, glm::radians(45.0f));
...
void display() {
    ...
    */
    ...
    T_.updateTransformations(cam_.getViewMatrix(), light_.getLightPos());
